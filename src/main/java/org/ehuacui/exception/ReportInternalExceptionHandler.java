...
/**
 * ReportInternalExceptionHandler.java 拦截所有Controller抛出的异常，以文件的方式记录到系统日志中<br />
 *
 * @author jianwei.zhou
 * @version 1.0 2016-4-27
 */
public class ReportInternalExceptionHandler implements HandlerExceptionResolver {

    private final static Logger logger = LoggerFactory.getLogger(ReportInternalExceptionHandler.class);
    ...
    public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object obj,
        ...
        // 把漏网的异常信息记入日志
        // 对Spring初始化的一些异常进行处理
        if (ex instanceof ReportInternalException) {
